...
export function Sidebar({
  ...
  // Highlight follows pending (in-flight) or visible tab for instant feedback.
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 flex h-screen flex-col border-r border-border bg-sidebar shadow-lg shadow-black/3 transition-[width,transform] duration-300 dark:shadow-black/20",
          "w-[260px]",
