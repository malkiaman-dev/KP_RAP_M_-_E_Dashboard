...
const cards: {
...
}[] = [
  {
    ...
    hint: "Assignment-frame girls with at least one survey submission",
    icon: Users,
    color: "text-teal",
  },
  {
    ...
    label: "Tracked Girls",
    hint: "Assignment-frame girls meeting the full tracking success criteria",
    icon: CheckCircle2,
    color: "text-teal",
  },
  {
    ...
    hint: "Attempted vs assignment-frame target",
    icon: Percent,
    color: "text-blue-600",
    suffix: "%",
    decimals: 1,
  },
  {
    ...
    label: "Success Rate %",
    hint: "Successfully tracked girls vs assignment-frame target",
    icon: Percent,
    color: "text-teal",
    suffix: "%",
    decimals: 1,
  },
  {
    ...
    label: "Not Tracked",
    hint: "Assignment-frame girls attempted but never successfully tracked",
    icon: UserX,
