...
const cards: {
  ...
  },
  {
    ...
    label: "Not Tracked",
    hint: "Never successfully tracked on any visit (excludes girls tracked on 2nd or 3rd attempt)",
    icon: UserX,
  ...
  },
  {
    ...
    label: "Duplicate Visit Groups",
    hint: "Girl + visit combinations with more than one submission — see Duplicate records for row counts",
    icon: Copy,
